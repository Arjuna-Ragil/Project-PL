...
export default async function ProductDetail({ params }) {
  ...
  return (
    <div className="h-1/2 w-full p-10 pt-35">
      <div className="flex h-full w-full flex-row gap-10 rounded-2xl bg-white p-15">
        ...
        <div className="flex flex-col gap-5 py-3">
          <div className="flex flex-col gap-2">
            <h2 className="truncate text-4xl font-bold">{product.brand}</h2>
            <h3 className="truncate text-4xl">{product.name}</h3>
            <p className="text-background3 truncate text-3xl">
